...
use crate::services::external_auth_service::{
    ...
    ExternalAuthProviderAuditDetails, UpdateExternalAuthProviderInput,
};
...
#[api_docs_macros::path(
    ...
    responses(
        (status = 200, description = "External auth providers", body = inline(ApiResponse<Vec<external_auth_service::AdminExternalAuthProviderInfo>>)),
...
pub async fn list_external_auth_providers(
    ...
    let providers = external_auth_service::list_admin_providers(&state).await?;
