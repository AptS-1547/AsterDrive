...
export interface components {
    schemas: {
        ...
        /** @enum {string} */
        MfaChallengeMethod: "totp" | "recovery_code";
        MfaChallengeVerifyRequest: {
            code: string;
            flow_token: string;
            method: components["schemas"]["MfaChallengeMethod"];
        };
        ...
        MfaFactorInfo: {
            ...
            method: components["schemas"]["MfaFactorMethod"];
            name: string;
        };
        /**
         * @description MFA 因子类型。MVP 只把 TOTP 作为持久化 factor。
         * @enum {string}
         */
        MfaFactorMethod: "totp";
        /**
