...
```text
主控节点 -> follower base_url
用户浏览器 -> follower base_url
...
用户浏览器
  |
  +-- https://drive.example.com        -> 主控节点
  |
  +-- https://follower-a.example.com   -> 从节点

主控节点 -> https://follower-a.example.com
从节点   -> https://drive.example.com
```
...
tailnet / VPN
  |
  +-- 主控节点
  +-- 从节点：100.x.y.z 或 follower.tailnet-name.ts.net
  +-- 用户浏览器
```
